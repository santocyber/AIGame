...
function chatGPTRequest($npcId, $nickname, $conversationHistory) {
    ...
    if ($npcId == 3) {  // NPC Médico
        $personalidade = 'Você é um médico NPC. Suas respostas são baseadas em informações científicas e médicas de fontes confiáveis. Responda de forma clara e objetiva, citando artigos médicos e estudos relevantes quando necessário.';
    }
